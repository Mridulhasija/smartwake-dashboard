...
<section className="glass rounded-[40px] px-6 py-16 md:px-12">
<div className="mx-auto max-w-4xl text-center">
<div className="mb-6 inline-flex rounded-full border border-cyan-400/20
...
<div className="rounded-full bg-cyan-500/10 px-3 py-1 text-xs fontsemibold text-cyan-300">
Smart Alerts
</div>
</div>
<AlarmForm />
...
Upcoming Alarms
  ...
  <div className="rounded-full bg-purple-500/10 px-3 py-1 text-xs fontsemibold text-purple-300">
Live Status
</div>
</div>
<AlarmList />
          ...
          <section className="mt-8 grid gap-6 lg:grid-cols-3">
            <div className="glass rounded-[30px] p-7">
              <div className="mb-6 flex items-center justify-between">
                ...
                <div className="rounded-full bg-cyan-500/10 px-3 py-1 text-xs font-semibold text-cyan-300">
                  Smart Alerts
                </div>
              </div>
            ...
            <div className="glass rounded-[30px] p-7">
              <div className="mb-6 flex items-center justify-between">
                ...
                <div className="rounded-full bg-purple-500/10 px-3 py-1 text-xs font-semibold text-purple-300">
                  Live Status
                </div>
              </div>
